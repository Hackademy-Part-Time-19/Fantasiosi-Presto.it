                ...
                <div class="d-flex justify-content-center align-items-center" style="min-height:75vh;">
                    <div class="left-side d-flex justify-content-center align-items-center flex-column" style=" width: 50%;"
                        ...
                        <div class="button-launch container d-flex justify-content-start align-items-start flex-column">
                            <h1>Ciao {{ Auth::user()->name }}, benvenuto sul nostro amichevole sito di Presto.it</h1>
            ...
            <main style="position: relative;">
                ...
                <div class="Featured-product" style="position: relative; z-index: 1; border:1px solid red">
                    <div class="title-product" style="margin-bottom: 6rem" data-aos="fade-down" data-aos-duration="1000">
                        ...
                        <p style="z-index: 1">Questi sono gli ultimi annunci inseriti nel nostro catalogo! Perchè non provi
                ...
                <div class="Testimonials d-flex justify-content-center flex-column align-items-center text-center"
                    ...
                    <p class="fw-normal"
                        ...
                        data-aos="fade-right" data-aos-duration="1000">Non sei sicuro di essere pronto per acquistare sul
                        nostro sito? Guarda che cosa hanno da dire le recensioni fatte dagli utenti!</p>
                    <div class="slideshow d-flex flex-row" style="width:25%; z-index: 1" data-aos="fade-down"
                        ...
                        <div class="card-customer flex-row">
                            ...
                            <div class="right-side-customer">
                                <p class="fw-normal p-3" style="color:var(--gray-text-color)">Lorem ipsum dolor sit amet
    ...
    @guest
        ...
        <main style="position: relative;">
            ...
            <div class="Featured-product" style="position: relative; z-index: 1">
                <div class="title-product" style="margin-bottom: 6rem" data-aos="fade-down" data-aos-duration="1000">
                    <h1 style="z-index: 1">Featured Product</h1>
                    <p style="z-index: 1">Questi sono gli ultimi annunci inseriti nel nostro catalogo! Perchè non provi a
                        dare un occhiata?</p>
                </div>
                <div class="row">
                    @foreach ($announcements as $announcement)
