            ...
            <div class="cards m-1 d-flex  flex-row gap-5 " style="z-index: 1; width: 100%; border: 2px solid var(--secondary-color);" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="background-color"></div>
                                    ...
                                    <div class="Testimonials d-flex justify-content-center flex-column align-items-center text-center"
                                        ...
                                        <div class="slideshow d-flex flex-row" style="width:25%; z-index: 1"
                                            ...
                                            <div class="card-customer flex-row">
                                                <div
                                                    ...
                                                    <img class="img-customer img-fluid" height="100" width="100"
                                                        ...
                                                        src="{{ Storage::url('immagini/Nuovo_progetto_1.jpg') }}"
                                                        alt="">
                                                    <h2>Fabiano</h2>
                                                    <h2>Buscemi</h2>
                                                </div>
                    ...
                    @guest
                        <section
                            style="border-bottom: 2px solid var(--secondary-color); background-color: var(--primary-color);">
                            <div class="d-flex justify-content-center align-items-center" style="min-height:75vh;">
                                <div class="left-side d-flex justify-content-center align-items-center flex-column"
                                    style=" width: 50%;" data-aos="zoom-out-right" data-aos-duration="1000">

                                    <div
                                        class="button-launch container d-flex justify-content-start align-items-start flex-column">
                                        <h1>{{ __('ui.welcome') }}</h1>
                                        <button id="button-primary" class="button-primary">
                                ...
                                <div class="right-side d-flex justify-content-center align-items-center "
                                    style=" width:50%;" data-aos="zoom-out-left" data-aos-duration="1000">
                                </div>
                            </div>
                        </section>
