  ...
  <div class="card text-center d-flex flex-column" style="width: 18rem; min-height: 35rem;">
    <img class="card-img-top" width="100%"  src="{{Storage::url('immagini/Nuovoprogetto.png')}}" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title text-dark">{{$title}}</h5>
      <p class="card-text" style="color: var(--gray-text-color); font-weight:300; font-size: 12px;">{{ Str::limit($body, 40) }}</p>
