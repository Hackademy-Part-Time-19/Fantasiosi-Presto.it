        ...
        <div class="d-flex align-items-center">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <div class="dropdown show d-flex align-items-center justify-content-center" style="position: relative">
                    <a class="btn dropdown-toggle p-0 px-2 text-center" style="height:20px; width:100%; font-size: 12px; back-drop-filter: blur(10px);" type="button" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Categorie
                    </a>
